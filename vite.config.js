...
export default () => {
  return defineConfig({
    base: '/supplyform/', // Specify the subfolder here
    plugins: [react()],
    define: {
      global: 'globalThis'
    },
    server: {
      port: 3000,
      proxy: 'https://cfashion.in/supplyform',
      cors: {
        origin: ['https://essaneinfotech.com/supplyform','https://cfashion.in/supplyform', 'http://localhost:3000'],
