    ...
    <div className='invoice-list-wrapper'>
      ...
      <CardBody>
        ...
        <Row>
          ...
          <Col md={3} className='mb-2'>
                <Label className='form-label' for='status'>
                  Select Sub Supply Type
                </Label>
                <Select
                  isClearable={false}
                  theme={selectThemeColors}
                  options={subsupplytype_option}
                  className='react-select'
                  classNamePrefix='select'
                  onChange={issetsubsupplytype}
                  value={subsupplytypeoption}
                />
          </Col>
          <Col md={3} className='mb-2'>
            ...
            <input
              name='subsupplydescription' // Add a name prop to match your form structure if needed
              id='subsupplydescriptionunt'
              placeholder=''
          ...
          <Col md={3} className='mb-2'>
                ...
                <Select
                  isClearable={false}
                  theme={selectThemeColors}
                  options={documenttype_option}
                  className='react-select'
                  classNamePrefix='select'
                  onChange={issetdocumenttype}
          ...
          <Col md={3} className='mb-2'>
                ...
                <Select
                  ...
                  className='react-select'
                  classNamePrefix='select'
                  onChange={issetactfromstate}
                  value={actfromstatevalue}
                />
          </Col>
          <Col md={3} className='mb-2'>
            <Label className='form-label' for='categoryname'>
          ...
          <Col md={3} className='mb-2'>
            ...
            <input
              name='toPlace' // Add a name prop to match your form structure if needed
              id='toPlace'
              placeholder=''
              className='custom-input-class form-control'
              style={{ fontSize: '16px' }}
          ...
          <Col md={3} className='mb-2'>
                ...
                <Select
                  ...
                  className='react-select'
                  classNamePrefix='select'
                  onChange={issetacttostate}
                  value={acttostatevalue}
                />
          </Col>
          <Col md={3} className='mb-2'>
            <Label className='form-label' for='categoryname'>
          ...
          <Col md={3} className='mb-2'>
            ...
            <input
              name='dispatchFromGSTIN' // Add a name prop to match your form structure if needed
              id='dispatchFromGSTIN'
              placeholder=''
              className='custom-input-class form-control'
              style={{ fontSize: '16px' }}
              value={dispatchFromGSTIN}
              onChange={e => setdispatchFromGSTIN(e.target.value)}
            />
          </Col>
          <Col md={3} className='mb-2'>
            <Label className='form-label' for='categoryname'>
              Dispatch From TradeName
            </Label>
            <input
              name='dispatchFromTradeName' // Add a name prop to match your form structure if needed
              id='dispatchFromTradeName'
              placeholder=''
              className='custom-input-class form-control'
              style={{ fontSize: '16px' }}
              value={dispatchFromTradeName}
              onChange={e => setdispatchFromTradeName(e.target.value)}
            />
          </Col>
          <Col md={3} className='mb-2'>
            <Label className='form-label' for='categoryname'>
            ...
            <input
              name='shipToGSTIN' // Add a name prop to match your form structure if needed
              id='shipToGSTIN'
              placeholder=''
              className='custom-input-class form-control'
              style={{ fontSize: '16px' }}
          ...
          <Col md={3} className='mb-2'>
            ...
            <input
              name='shipToTradeName' // Add a name prop to match your form structure if needed
              id='shipToTradeName'
              placeholder=''
              className='custom-input-class form-control'
              style={{ fontSize: '16px' }}
              value={shipToTradeName}
              onChange={e => setshipToTradeName(e.target.value)}
            />
          </Col>
          <Col md={3} className='mb-2'>
            <Label className='form-label' for='categoryname'>
            ...
            <input
              name='totalValue' // Add a name prop to match your form structure if needed
              id='totalValue'
              placeholder=''
              className='custom-input-class form-control'
              style={{ fontSize: '16px' }}
          ...
          <Col md={3} className='mb-2'>
            ...
            <input
              name='cgstValue' // Add a name prop to match your form structure if needed
              id='cgstValue'
              placeholder=''
              className='custom-input-class form-control'
              style={{ fontSize: '16px' }}
          ...
          <Col md={3} className='mb-2'>
            ...
            <input
              name='sgstValue' // Add a name prop to match your form structure if needed
              id='sgstValue'
              placeholder=''
              className='custom-input-class form-control'
              style={{ fontSize: '16px' }}
          ...
          <Col md={3} className='mb-2'>
            ...
            <input
              name='igstValue' // Add a name prop to match your form structure if needed
              id='igstValue'
              placeholder=''
              className='custom-input-class form-control'
              style={{ fontSize: '16px' }}
          ...
          <Col md={3} className='mb-2'>
            ...
            <input
              name='cessValue' // Add a name prop to match your form structure if needed
              id='cessValue'
              placeholder=''
              className='custom-input-class form-control'
              style={{ fontSize: '16px' }}
          ...
          <Col md={3} className='mb-2'>
            ...
            <input
              name='cessNonAdvolValue' // Add a name prop to match your form structure if needed
          ...
          <Col md={3} className='mb-2'>
            ...
            <input
              name='totInvValue' // Add a name prop to match your form structure if needed
              id='totInvValue'
              placeholder=''
              className='custom-input-class form-control'
              style={{ fontSize: '16px' }}
          ...
          <Col md={3} className='mb-2'>
                ...
                <Select
                  isClearable={false}
                  theme={selectThemeColors}
                  options={transmode_option}
                  className='react-select'
                  classNamePrefix='select'
                  onChange={issettransportationmode}
                  value={transportationmodevalue}
                />
          </Col>
          <Col md={3} className='mb-2'>
            <Label className='form-label' for='categoryname'>
            ...
            <input
              name='transDistance' // Add a name prop to match your form structure if needed
              id='transDistance'
              placeholder=''
              className='custom-input-class form-control'
              style={{ fontSize: '16px' }}
          ...
          <Col md={3} className='mb-2'>
                ...
                <Select
                  isClearable={false}
                  theme={selectThemeColors}
                  options={vehicletype_option}
                  className='react-select'
                  classNamePrefix='select'
                  onChange={issetvehicletype}
          ...
          <Col md={3} className='mb-2'>
            ...
            <input
              name='productName' // Add a name prop to match your form structure if needed
              id='productName'
              placeholder=''
              className='custom-input-class form-control'
              style={{ fontSize: '16px' }}
          ...
          <Col md={3} className='mb-2'>
            ...
            <input
              name='productDesc' // Add a name prop to match your form structure if needed
              id='productDesc'
              placeholder=''
              className='custom-input-class form-control'
              style={{ fontSize: '16px' }}
          ...
          <Col md={3} className='mb-2'>
            ...
            <input
              name='hsnCode' // Add a name prop to match your form structure if needed
              id='hsnCode'
              placeholder=''
              className='custom-input-class form-control'
              style={{ fontSize: '16px' }}
          ...
          <Label className='form-label' for='status'>
              QTY Unit
                ...
                <Select
                  isClearable={false}
                  theme={selectThemeColors}
                  options={qtyUnit_options}
                  className='react-select'
                  classNamePrefix='select'
                  onChange={issetqtyunit}
                  value={qtyunitvalue}
                />
          </Col>
          <Col md={2} className='mb-2'>
            ...
            <input
              name='quantity' // Add a name prop to match your form structure if needed
              id='quantity'
              placeholder=''
              className='custom-input-class form-control'
              style={{ fontSize: '16px' }}
          ...
          <Col md={2} className='mb-2'>
            ...
            <input
              name='taxableAmount' // Add a name prop to match your form structure if needed
              id='taxableAmount'
              placeholder=''
              className='custom-input-class form-control'
              style={{ fontSize: '16px' }}
          ...
          <Col md={2} className='mb-2'>
            ...
            <input
              name='sgstRate' // Add a name prop to match your form structure if needed
              id='sgstRate'
              placeholder=''
              className='custom-input-class form-control'
              style={{ fontSize: '16px' }}
          ...
          <Col md={2} className='mb-2'>
            ...
            <input
              name='cgstRate' // Add a name prop to match your form structure if needed
              id='cgstRate'
              placeholder=''
              className='custom-input-class form-control'
              style={{ fontSize: '16px' }}
          ...
          <Col md={2} className='mb-2'>
            ...
            <input
              name='igstRate' // Add a name prop to match your form structure if needed
              id='igstRate'
              placeholder=''
              className='custom-input-class form-control'
              style={{ fontSize: '16px' }}
          ...
          <Col md={2} className='mb-2'>
            ...
            <input
              name='cessRate' // Add a name prop to match your form structure if needed
              id='cessRate'
              placeholder=''
              className='custom-input-class form-control'
              style={{ fontSize: '16px' }}
